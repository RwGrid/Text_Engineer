 ...
 * Use the {@link KeywordsFragment#newInstance} factory method to
...
public class KeywordsFragment extends Fragment {
     ...
     * @return A new instance of fragment KeywordsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static KeywordsFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_keywords, container, false);
        RichText=v.findViewById(R.id.editTextKeywords);
        btnSubmitText=v.findViewById(R.id.btnSubmitKeywords);
        ...
        fabClearRichtxt=v.findViewById(R.id.fabClearRichTextKeywords);
    ...
    public   void submitData(View v){
        ...
        Call<List<KeywordItem>> call=callManager.send_data_retrieve_keywords(submitted_Rich_Text);
        ...
        call.enqueue(new Callback<List<KeywordItem>>() {
            ...
            public void onResponse(Call<List<KeywordItem>> call, Response<List<KeywordItem>> response) {
                if(response.isSuccessful()){
                    ...
                    List<KeywordItem> itemList=response.body();
